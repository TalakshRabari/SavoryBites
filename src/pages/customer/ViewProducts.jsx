            ...
            <div>
                ...
                <div className="sidebar toggle-sidebar">
                    ...
                    <div className="side-bar-part-1 mb-32">
                        <h6 className="mb-16 color-primary">Latest Article</h6>
                        <hr className="mb-16 light-gray" />
                        <div className="d-flex gap-16 mb-16">
                            <img className="br-4" src="savory/assets/media/blog/article-img-1.jpg" alt />
                            <div className="latest-article">
                                <a href="blog-detail.html" className="hover-link fw-600 dark-gray mb-8">Overhead
                                    shot of pepperoni
                                    burger</a>
                                <p className="light-gray">Dec 10, 2024</p>
                            </div>
                        </div>
                        <div className="d-flex gap-16 mb-16">
                            <img className="br-4" src="savory/assets/media/blog/article-img-2.jpg" alt />
                            <div className="latest-article">
                                <a href="blog-detail.html" className="hover-link fw-600 dark-gray mb-8">Hot dog
                                    dressed
                                    in<br />mustard</a>
                                <p className="light-gray">Dec 10, 2024</p>
                            </div>
                        ...
                        <div className="d-flex gap-16">
                            <img className="br-4" src="savory/assets/media/blog/article-img-3.jpg" alt />
                            <div className="latest-article">
                                <a href="blog-detail.html" className="hover-link fw-600 dark-gray mb-8">Indulge in
                                    asesame bun
                                    burger, crispy fries</a>
                                <p className="light-gray">Dec 10, 2024</p>
                            </div>
                        </div>
                    </div>
